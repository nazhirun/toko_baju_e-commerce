<?php
/* Smarty version 4.3.1, created on 2023-06-21 15:21:43
  from 'module:ps_linklistviewstemplateshooklinkblock.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6492b317df2db3_82565647',
...
function content_6492b317df2db3_82565647 (Smarty_Internal_Template $_smarty_tpl) {
  ...
  <div class="row">
      ...
      <ul id="footer_sub_menu_1" class="collapse">
            ...
            <a
                ...
                class="cms-page-link"
                href="http://localhost/toko-baju/turun-harga"
            ...
            <a
                ...
                class="cms-page-link"
                href="http://localhost/toko-baju/produk-terbaru"
            ...
            <a
                ...
                class="cms-page-link"
                href="http://localhost/toko-baju/terlaris"
      ...
      <ul id="footer_sub_menu_2" class="collapse">
            ...
            <a
                ...
                class="cms-page-link"
                href="http://localhost/toko-baju/content/1-pengiriman-barang"
            ...
            <a
                ...
                class="cms-page-link"
                href="http://localhost/toko-baju/content/2-kebijakan-privasi-dan-hukum"
            ...
            <a
                ...
                class="cms-page-link"
                href="http://localhost/toko-baju/content/3-syarat-pemakaian"
            ...
            <a
                ...
                class="cms-page-link"
                href="http://localhost/toko-baju/content/4-tentang-kami"
            ...
            <a
                ...
                class="cms-page-link"
                href="http://localhost/toko-baju/content/5-pembayaran"
                title="Pembayaran"
                            >
              Pembayaran
            </a>
            ...
            <a
                ...
                class="cms-page-link"
                href="http://localhost/toko-baju/hubungi-kami"
            ...
            <a
                ...
                class="cms-page-link"
                href="http://localhost/toko-baju/sitemap"
            ...
            <a
                ...
                class="cms-page-link"
                href="http://localhost/toko-baju/toko"
                title=""
                            >
              Toko
            </a>
